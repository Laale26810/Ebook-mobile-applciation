...
class Horror2 extends StatelessWidget {
  const Horror2({super.key});
                  ...
                  Container(
                    decoration: BoxDecoration(
                      ...
                      image: const DecorationImage(
                        fit: BoxFit.cover,
                        image:
                            AssetImage('assets/images/frame_1171275442.jpeg'),
                      ),
                    ),
                    width: 77,
                    height: 121,
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 10),
                        Text(
                          'This novel transcends the boundaries of traditional storytelling by blending genres like romance, suspense, and supernatural horror into an intricate tapestry that keeps you enthralled from the very first page.',
                          style: GoogleFonts.getFont(
                            'Inter',
