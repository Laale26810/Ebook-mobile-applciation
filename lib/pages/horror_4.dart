...
class Horror4 extends StatelessWidget {
  const Horror4({super.key});
                  ...
                  Container(
                    decoration: BoxDecoration(
                      ...
                      image: const DecorationImage(
                        fit: BoxFit.cover,
                        image:
                            AssetImage('assets/images/frame_1171275443.jpeg'),
                      ),
                    ),
                    width: 77,
                    height: 121,
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 10),
                        Text(
                          'It\'s a play on the Horror trope that Black people always die first and if they don\'t die first you know they won\'t make it to the end of the movie.',
                          style: GoogleFonts.getFont(
                            'Inter',
